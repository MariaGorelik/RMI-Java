...
public class RemoteDoctorServer extends UnicastRemoteObject implements Doctor.RemoteDoctor
{
	...
	throws RemoteException, Doctor.RecordException
    {
        ...
        System.out.print("\nPatient " + acct.userFullName + " disconnected");
	...
	throws RemoteException, Doctor.RecordException
    {
        ...
        synchronized(acct) {
            ...
            {
                throw new Doctor.RecordException("\nIncorrect day or(and) time type");
            }
            if (records[daysToInt.get(day)][timesToInt.get(time)] != null)
            {
                throw new Doctor.RecordException("\nThis time is not available, try another option");
            }
            acct.day = day;
            acct.time = time;
            ...
            System.out.print("\nPatient " + acct.userFullName + " registered:\n");
...
//    }
    ...
    public static void main(String[] args) {
        try {
            System.setProperty("java.rmi.server.hostname", "192.168.11.8"); // added
